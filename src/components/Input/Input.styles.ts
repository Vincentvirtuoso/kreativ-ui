  ...
  "group relative inline-flex items-center gap-2 transition-colors",
  {
    variants: {
      variant: {
        ...
        filled: "border border-transparent bg-surface-raised text-text hover:bg-surface",
        ghost: "border border-transparent bg-transparent text-text hover:bg-surface-raised",
      },
      state: {
