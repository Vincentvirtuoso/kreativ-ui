            ...
            (e: React.KeyboardEvent<HTMLButtonElement>) => {
                ...
                switch (e.key) {
                    ...
                    case "End": {
                        ...
                        const values = orderedEnabledValues(ctx.items);
                        if (values.length) {
                            ctx.setActiveValue(values[values.length - 1]);
                        }
                        break;
                    }
        ...
        return (
            ...
            >
                <button
                    ...
                    className="min-w-0 flex-1 bg-transparent text-left outline-none disabled:cursor-not-allowed relative"
                    {...props}
                >
                    {children}
                    <span
                        aria-hidden
                        className="pointer-events-none flex items-center text-text-muted absolute right-0 top-1/2 flex -translate-y-1/2 items-center gap-1.5"
                    >
                        <ChevronDown
                            size={14}
                            className={cn(
